...
i18n.localize = function(app, options) {
    ...
    function middleware(req, res, next) {
        ...
        if (!locale) {
            locale = model.get('_session.i18n.locale');
        }
    ...
    function _translate(key) {
        ...
        return o.backend.get(model, model.get('_session.i18n.locale'), model.get('_session.i18n.namespace'), key);
    }
    function _locale() {
        return this.view.model.get('_session.i18n.locale');
    }
    function _language() {
        return this.view.model.get('_session.i18n.language');
    }
    function _region() {
        return this.view.model.get('_session.i18n.region');
    }
    function _localizedPath(path) {
        return o.urlScheme == 'path' ? '/'+this.view.model.get('_session.i18n.locale')+'/'+path : path;
    }
